 ...
 * servidor. Tipos são apagados em compilação, então a importação não cria
 * nenhuma dependência de runtime.
 *
 * O formato espelha, campo a campo, o contrato de saída JSON que o prompt exige
 * do modelo. Se o prompt mudar, este contrato muda junto — manter os dois
