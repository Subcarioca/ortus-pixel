/**
 * =============================================================================
 * COMUNIDADE — comentários com identidade social (Discord / Google)
 * =============================================================================
 *
 * DECISÃO DE PRODUTO: comentário exige login social. Não existe comentário
 * anônimo nem por e-mail.
 *
 ...
 *   - o atacante precisa de contas reais de Discord/Google (caras de fabricar
 *     em escala, e ambos os provedores já pagam o custo do antiabuso por nós);
 ...
 *
 * POR QUE OS DOIS PROVEDORES, e não só um: Discord é onde o fandom nerd já vive
 * (e o projeto já tem comunidade lá), mas boa parte do público mobile brasileiro
 * não usa Discord no celular e tem sessão do Google sempre aberta. Oferecer os
 * dois é a diferença entre "eu comento" e "deixa pra lá".
 *
 * LGPD — MINIMIZAÇÃO DE DADOS (o princípio que rege todo este arquivo):
 * guardamos o MÍNIMO necessário para a funcionalidade existir.
 *
...
export const COMMENT_PROVIDERS = ['discord', 'google'] as const;
